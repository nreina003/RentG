                    ...
                    <div id="elements">
                        <table>
                            ...
                            <%
                                ...
                                System.out.println(SvrConsultarReservas.getInstance().buscarReservasPorFechaCliente(fecha, email));
                                ArrayList<Reserva> reservas = SvrConsultarReservas.getInstance().buscarReservasPorFechaCliente(fecha, email);
